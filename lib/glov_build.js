...
BuildJob.prototype.out = function (file) {
  this.wait();
  // TODO: flush all files simultaneously at end of job, and immediately before flushing job state
  ...
  this.gb.files.put({
    ...
    this.job_state.outputs[buildfile.key] = buildfile.timestamp;
    this.done();
  });
};
